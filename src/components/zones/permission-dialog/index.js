...
function getLocales () {
  return {
    ...
    'chat messages': l('chat messages', 'messages de chat', 'messaggi chat', 'Chatnachrichten', 'mensajes de chat', 'mensagens de chat', 'сообщения чата', '聊天消息', '聊天訊息', 'チャットメッセージ', '채팅 메시지'),
    ...
    'contact lists': l('contact lists', 'listes de contacts', 'liste di contatti', 'Kontaktlisten', 'listas de contactos', 'listas de contatos', 'списки контактов', '联系人列表', '聯絡人清單', '連絡先リスト', '연락처 목록'),
    ...
    'site lists': l('site lists', 'listes de sites', 'elenchi di siti', 'Website-Listen', 'listas de sitios', 'listas de sites', 'списки сайтов', '站点列表', '網站清單', 'サイトリスト', '사이트 목록'),
