import{a as S,c as I,d as A}from"./chunk-TRGJJ7FQ.js";import{c as k}from"./chunk-X4PLS555.js";import"./chunk-FNRD6YAI.js";import{h as b,l as w,o as y}from"./chunk-NID4PPA7.js";import{b as g}from"./chunk-TBF35Z4Q.js";import{g as u,j as a,n as m,s as i,v as $}from"./chunk-EOHNSKYH.js";u("singleNapp",function(){let c=g(localStorage),{session_openWorkspaceKeys$:s}=c,o=s()[0];if(!o)throw new Error("User n/a");return I(()=>({isOpen$:!1,open(){this.isOpen$(!0)},close(){this.isOpen$(!1)}})),i("napp",()=>{let r,l=[window.location].map(e=>(e.pathname.replace(/\/\+{1,3}[^/?#]+\/?/,p=>(r=p.replace(/^\/|\/$/g,""),"")).replace(/\/$/,"")+e.search+e.hash).replace(/^([^?#])/,"/$1"))[0],n=k(r),t=y(n);return{wsKey:o,appId:t,initialRoute:l}}),this.h`
    <vault-modal />
