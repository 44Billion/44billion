import{b as Ae,c as ne,d as Ee}from"./chunk-4NYNH44B.js";import{d as Se,e as ce,m as Me,n as oe}from"./chunk-DF4IVW5S.js";import{a as ke,e as N,g as be,i as ve,l as le,n as se}from"./chunk-YCNW34TK.js";import{a as j,b as V,f as z}from"./chunk-KN6GOQRR.js";import{h as C,j as ie,k as $e,o as I,p as te,q as J,r as we,t as Q,w as B}from"./chunk-K2UKPH6Q.js";function Be(t){if(t instanceof Error)return t;let e=new Error(t.message);return e.name=t.name||"Error",e.stack=t.stack,Object.assign(e,t.context||{}),e}var Ke=!1,Le=Ke?"http://":"https://",Ne=Ke?"localhost:10000":"44billion.net",nt=`${Le}${Ne}`;var G={};function We(){return Math.random().toString(36).slice(2)+Math.random().toString(36).slice(2)}function Fe(t,e,s=5e3){if(!t||!e)throw new Error("Missing request id or code");let{promise:r,resolve:i,reject:c}=Promise.withResolvers();G[t]={resolve:i,reject:c};let o;return s!=null&&(s>0?o=setTimeout(()=>{G[t]?.reject?.(`Timeout for ${e} reqId: ${t}`)},s):G[t]?.reject?.(`Timeout for ${e} reqId: ${t}`)),r.finally(()=>{clearTimeout(o),delete G[t]})}function De(t){let e=G[t.data.reqId];if(!e){console.log(`Unhandled response for reqId ${t.data.reqId} (may have timed out)`,JSON.stringify(t.data));return}t.data.error?e.reject(Be(t.data.error)):e.resolve({payload:t.data.payload,isLast:t.data.isLast??!0,ports:t.ports})}var je=((t,e=new WeakMap,s=new FinalizationRegistry(r=>r.abort()))=>r=>{let i=r instanceof MessagePort;if(t=i?r:globalThis,e.has(t))return;let c=new AbortController;e.set(t,c),t.addEventListener("message",async o=>{if(o.data.code==="REPLY")return De(o)},{signal:c.signal}),i&&t.start(),s.register(t,c)})();async function ue(t,e,s,r){if(!e.code&&!("payload"in e))throw new Error("Missing args");(!s||typeof s!="object")&&(s={targetOrigin:s,transfer:r}),je(t);let i=We(),c=Fe(i,e.code,s.timeout);return t.postMessage({...e,reqId:i},s),c.then(({payload:o,ports:d})=>({code:e.code,payload:o,ports:d})).catch(o=>({code:e.code,payload:null,error:o}))}function O(t,e,s,r){if(!("payload"in e)&&!("error"in e))throw new Error("Missing args");if((!s||typeof s!="object")&&(s={targetOrigin:s,transfer:r}),s.targetOrigin??=t.origin,!s.to&&!t.source)throw new Error("Set port to options.to");s.to??=t.source,s.to.postMessage({...e,reqId:t.data.reqId,code:"REPLY"},s)}function W(t,e,s,r){if(!e.code||!("payload"in e)&&!("error"in e))throw new Error("Missing args");(!s||typeof s!="object")&&(s={targetOrigin:s,transfer:r}),t.postMessage(e,s)}async function Ve(t,e,s){try{let r=s.map(n=>Me(n)),i=new Blob(r,{type:e.contentType}),c=new FileReader,d=await new Promise((n,l)=>{c.onload=()=>n(c.result),c.onerror=l,c.readAsDataURL(i)}),p={fx:e.rootHash,url:d};return j(localStorage,`session_appById_${t}_icon`,p),p}catch(r){console.log("Failed to update icon storage:",r)}}async function yt(t,e,s,r,i,c,o,d,p,n,l,{signal:m,isSingleNapp:u=!1}={}){let h=ve(t),g=N(h)===JSON.parse(localStorage.getItem("session_defaultUserPk")),E=new URL(JSON.parse(localStorage.getItem("config_vaultUrl")));document.querySelector(`iframe[src="${E.href.replace(/\/$/,"")}"]`)||console.warn("Vault iframe not found");let K=le(e),S=await oe.create(e,K);u&&S.updateBundleMetadata({lastOpenedAsSingleNappAt:Date.now()});let _=null,k=null;m?.addEventListener("abort",()=>{_&&(_.close(),_=null),k&&(k.close(),k=null)},{once:!0});let T,M=location.origin.replace("//",`//${s}.`);window.addEventListener("message",y=>{y.data.code!=="TRUSTED_IFRAME_READY"||y.source!==i.contentWindow||y.origin!==M||(T?.abort(),T=new AbortController,_&&_.close(),_=y.ports[0],H(_,AbortSignal.any([m,T.signal])),ye(s,r))},{signal:m});let q=!1;function ye(y,x=""){if(q)return;q=!0;let $;window.addEventListener("message",f=>{f.data.code!=="APP_IFRAME_READY"||f.source!==c.contentWindow||f.origin!==M||($?.abort(),$=new AbortController,k&&k.close(),k=f.ports[0],Ue(k,AbortSignal.any([m,$.signal])))},{signal:m});let a=window.location.host;o(`//${y}.${a}${x}`)}function H(y,x){y.addEventListener("message",async $=>{switch($.data.code){case"STREAM_APP_FILE":{let a=(f,b=new Error("FILE_NOT_CACHED"))=>(f&&console.log(f),O($,{error:b,isLast:!0},{to:y}));try{let f=await S.getFileCacheStatus($.data.payload.pathname,null,{withMeta:!0});if(!f.isCached)if(f.isHtml)a(null,new Error("HTML_FILE_NOT_CACHED"));else{let{fileRootHash:A,total:v}=f,w=0,P=-1,R=!1,Y=!1,xe=async({progress:Z,newlyCachedChunkIndexRanges:he,error:_e})=>{if(R||Y)return;if(_e){R=!0;let U=d(),{[$.data.payload.pathname]:ee,...D}=U;return d(D),a(_e)}let me=$.data.payload.pathname,Ie=d();if(d({...Ie,[me]:{progress:Z,totalByteSizeEstimate:v?(v-1)*51e3:0}}),Z>=100&&setTimeout(()=>{let U=d(),{[me]:ee,...D}=U;d(D)},1e3),he.length>0)for(let U of he)P=Math.max(P,U[1]);else if(v!==null)P=v-1;else return a(new Error("No cached chunks"));for(;w<=P&&!R&&!Y;)try{let U=await Se(e,A,{fromPos:w,toPos:w});if(U.length===0)return R=!0,a(new Error(`Missing chunk at index ${w} for rootHash ${A}`));let ee=U[0];if(v===null){let Ce=ee.evt.tags.find(ge=>ge[0]==="c"&&ge[1].startsWith(`${A}:`)),ae=parseInt(Ce?.[2]);!Number.isNaN(ae)&&ae>0&&(v=ae)}if(v===null)return R=!0,a(new Error("Unable to determine total chunks."));let D=v!=null&&w===v-1;O($,{payload:{content:ee.evt.content,...w===0&&{contentType:f.contentType}},isLast:D},{to:y}),w++,D&&(Y=!0)}catch(U){return R=!0,a(U)}};try{return S.cacheFile($.data.payload.pathname,f.fileTag,xe)}catch(Z){return a(Z)}}let b=0;for await(let A of ce(e,S.getFileRootHash($.data.payload.pathname)))O($,{payload:{content:A.evt.content,...b===0&&{contentType:f.contentType}},isLast:++b===f.total},{to:y})}catch(f){return a(f,f)}break}}},{signal:x}),y.start(),W(y,{code:"BROWSER_READY",payload:null})}let F=new Map,X=new Map;async function re(y,x,{timeoutMs:$=1750}={}){if(F.has(y))return F.get(y);X.has(y)||X.set(y,{icon:!1,name:!1,promise:null});let a=X.get(y);if(a.promise)return a.promise;x??=le(y);let f=await oe.create(y,x),b={id:y,napp:Ae(x)},A=[];!("icon"in b)&&!a.icon&&(a.icon=!0,A.push(f.getIcon().then(w=>w&&(b.icon=w)).finally(()=>{a.icon=!1}))),!("name"in b)&&!a.name&&(a.name=!0,A.push(f.getName().then(w=>w&&(b.name=w)).finally(()=>{a.name=!1})));let v=(async()=>{if(A.length>0){let w=Promise.all(A).then(()=>F.set(y,b));await Promise.race([w,new Promise(P=>setTimeout(P,$))])}return F.set(y,b),X.delete(y),b})();return a.promise=v,v}function Ue(y,x){y.addEventListener("message",async $=>{switch($.data.code){case"OPEN_APP":{let a;try{let{href:f}=$.data.payload,A=new URL(f,self.location.origin).pathname,v=/^\/(\+{1,3}[a-zA-Z0-9]{48,})/,w=A.match(v);if(!w){console.error("Invalid app URL format:",f);break}let P=w[1],R=ne(P);a=se(R);let Y=await re(a,R,{timeoutMs:0});await n({app:await re(e,K),name:"openApp",eKind:null,meta:{targetApp:Y}}),l(f)}catch(f){let b=!1;for(let A of JSON.parse(localStorage.getItem("session_workspaceKeys"))??[])if(b=Array.isArray(JSON.parse(localStorage.getItem(`session_workspaceByKey_${A}_appById_${a}_appKeys`))),b)break;b||(j(localStorage,`session_appById_${a}_icon`,void 0),j(localStorage,`session_appById_${a}_name`,void 0),j(localStorage,`session_appById_${a}_description`,void 0),j(localStorage,`session_appById_${a}_relayHints`,void 0),await(await oe.create(a)).clearAppFiles()),console.error("Error in OPEN_APP handler:",f)}break}case"NIP07":{if(["peek_public_key","get_public_key"].includes($.data.payload.method)&&$.data.payload.ns[0]===""&&$.data.payload.ns.length===1){O($,{payload:h},{to:y});break}let{ns:a,method:f,params:b=[]}=$.data.payload,A=await re(e,K,{timeoutMs:0}),v;try{v=await Je(p,h,a,f,b,{isDefaultUser:g,requestPermission:n,app:A})}catch(w){v={error:w}}O($,v,{to:y});break}case"WINDOW_NAPP":{qe($);break}case"STREAM_APP_ICON":{try{let a=S.getFaviconMetadata();if(!a){O($,{error:new Error("No favicon"),isLast:!0},{to:y});break}let f=await S.getFileCacheStatus(null,a.tag,{withMeta:!0});f.isCached||(await S.cacheFile(null,a.tag),f=await S.getFileCacheStatus(null,a.tag,{withMeta:!0}));let A=JSON.parse(localStorage.getItem(`session_appById_${e}_icon`))?.fx!==a.rootHash,v=[],w=0;for await(let P of ce(e,a.rootHash))A&&v.push(P.evt.content),O($,{payload:{content:P.evt.content,...w===0&&{mimeType:a.mimeType||f.mimeType,contentType:a.contentType||f.contentType}},isLast:++w===f.total},{to:y});if(v.length>0){let{url:P}=await Ve(e,a,v);if(F.has(e)){let R=F.get(e);R.icon={fx:a.rootHash,url:P}}}}catch(a){console.log(a.stack),O($,{error:a,isLast:!0},{to:y})}break}case"CACHE_APP_FILE":{try{let a=({progress:f,error:b})=>{if(b)O($,{error:b,isLast:!0},{to:y});else{let A=f>=100;O($,{payload:f,isLast:A},{to:y})}};S.cacheFile($.data.payload.pathname,null,a)}catch(a){console.log($.data.payload.pathname,"error:",a.stack),O($,{error:a,isLast:!0},{to:y})}break}}},{signal:x}),y.start(),W(y,{code:"BROWSER_READY",payload:null})}}function qe(t){return O(t,{error:new Error("Not implemented yet")})}var He={getPublicKey:"readProfile",signEvent:"signEvent",nip04Encrypt:"encrypt",nip04Decrypt:"decrypt",nip44Encrypt:"encrypt",nip44Decrypt:"decrypt"};function Ye(t){return He[t]||(()=>{throw new Error(`Unknown method ${t}`)})()}async function Je(t,e,s,r,i,{isDefaultUser:c,requestPermission:o,app:d}={}){if(c)throw new Error("Please login");if(o){let m=r.includes("_")?r.replace(/_([a-z0-9])/g,(h,g)=>g.toUpperCase()):r,u=(()=>{switch(m){case"signEvent":return i?.[0]?.kind;default:return null}})();await o({app:d,name:Ye(m),eKind:u,meta:{params:i}})}let{napp:p,...n}=d,l={code:"NIP07",payload:{app:{...n,id:p},pubkey:e,ns:s,method:r,params:i}};return t(l,{timeout:12e4})}function de(){return N(Qe(),43)}function Qe(){let t=crypto.getRandomValues(new Uint8Array(40)),s=2n**256n-0x14551231950b75fc4402da1732fc9bebfn;return(((o,d)=>{let p=o%d;return p>=0n?p:d+p})((o=>BigInt("0x"+(ke(o)||"0")))(t),s-1n)+1n).toString(16).padStart(64,"0")}var Pe=["+32PaEXMJYPC2Hj9F1oRFfg7RTwdBlbFuPQE85fvjsF2ygI4cPTw0YoUh","+cB3lFAQviXRJmg7z5TJJoPALS3CKwd2Pvs2rSVW5hflKR70lfbqbBklPQ"].map(ne).map(se);function ze(){let t=V(localStorage);return we("hardcoded_newAppIdsObj",{}),B(()=>{if(t.session_workspaceKeys$())return;let e=de();t.session_defaultUserPk$(e),Te({userPk:e,storage:t,isFirstTimeUser:!0})}),B(()=>{if(!t.session_workspaceKeys$())return;let e=t.session_workspaceKeys$()||[],s=t.session_defaultUserPk$();e.forEach(r=>{let i=t[`session_workspaceByKey_${r}_userPk$`]();i!=null&&i!==s&&!(t[`session_accountByUserPk_${i}_isReadOnly$`]()??!1)&&t[`session_accountByUserPk_${i}_isLocked$`](!0)})}),B(({track:e})=>{if(e(()=>t.session_workspaceKeys$().length>0))return;let s=de();t.session_defaultUserPk$(s),Te({userPk:s,storage:t,isFirstTimeUser:!0})}),t}function Te({userPk:t,storage:e,isFirstTimeUser:s}){let r=Pe.map((o,d)=>({id:o,key:Math.random().toString(36).slice(2)+Math.random().toString(36).slice(2),visibility:"closed",isNew:!1})),i=Math.random().toString(36).slice(2)+Math.random().toString(36).slice(2);e.config_isSingleWindow$()===void 0&&e.config_isSingleWindow$(!1);let c=[];e[`session_workspaceByKey_${i}_openAppKeys$`](c),e[`session_workspaceByKey_${i}_userPk$`](t),r.forEach(o=>{e[`session_workspaceByKey_${i}_appById_${o.id}_appKeys$`]([o.key]),e[`session_appByKey_${o.key}_id$`](o.id),e[`session_appByKey_${o.key}_visibility$`](o.visibility),e[`session_appByKey_${o.key}_route$`]("")}),e[`session_workspaceByKey_${i}_unpinnedCoreAppIdsObj$`]({}),e[`session_workspaceByKey_${i}_pinnedAppIds$`](r.map(({id:o})=>o)),e[`session_workspaceByKey_${i}_unpinnedAppIds$`]([]),e[`session_accountByUserPk_${t}_isReadOnly$`](!0),e[`session_accountByUserPk_${t}_isLocked$`](!1),e[`session_accountByUserPk_${t}_profile$`]({npub:Ee(be(t)),meta:{events:[]}}),e[`session_accountByUserPk_${t}_relays$`]({meta:{events:[]}}),e.session_accountUserPks$([t]),e.session_workspaceKeys$([i]),e.session_openWorkspaceKeys$([i])}async function pe(t,e){let s=e.session_workspaceKeys$()||[],r=e.session_openWorkspaceKeys$()||[],i=e.session_defaultUserPk$(),c=s.length===1&&s.every(n=>e[`session_workspaceByKey_${n}_userPk$`]()===i);if(t.length===0&&c)return;let o=e.session_accountUserPks$()||[],d=t.map(n=>N(n.pubkey)),p;if(t.forEach(n=>{let l=N(n.pubkey);e[`session_accountByUserPk_${l}_isReadOnly$`](p=n.isReadOnly??!1),e[`session_accountByUserPk_${l}_isLocked$`](p?!1:n.isLocked??!0),e[`session_accountByUserPk_${l}_profile$`](n.profile),e[`session_accountByUserPk_${l}_relays$`](n.relays)}),c&&d.length===1){let n=s[0],l=d[0],m=e[`session_workspaceByKey_${n}_openAppKeys$`]()||[],u=[];m.forEach(h=>{e[`session_appByKey_${h}_visibility$`](g=>(g==="open"&&u.push(h),"closed"))}),e[`session_workspaceByKey_${n}_openAppKeys$`]([]),e[`session_workspaceByKey_${n}_userPk$`](l),await new Promise(h=>window.requestIdleCallback(()=>window.requestIdleCallback(h,{timeout:50}),{timeout:100})),u.forEach(h=>{e[`session_appByKey_${h}_visibility$`]("open")}),e[`session_workspaceByKey_${n}_openAppKeys$`](u),e.session_defaultUserPk$(void 0)}else{let n=d.filter(_=>!o.includes(_)),l=o.filter(_=>!d.includes(_));n.length>0&&i&&e.session_defaultUserPk$(void 0);let m=[];for(let _ of l)m=m.concat(s.filter(k=>e[`session_workspaceByKey_${k}_userPk$`]()===_));let u=[];for(let _ of n){let k=Pe.map(M=>({id:M,key:Math.random().toString(36).slice(2)+Math.random().toString(36).slice(2),visibility:"closed",isNew:!1})),T=Math.random().toString(36).slice(2)+Math.random().toString(36).slice(2);u.push(T),e[`session_workspaceByKey_${T}_openAppKeys$`]([]),e[`session_workspaceByKey_${T}_userPk$`](_),k.forEach(M=>{e[`session_workspaceByKey_${T}_appById_${M.id}_appKeys$`]([M.key]),e[`session_appByKey_${M.key}_id$`](M.id),e[`session_appByKey_${M.key}_visibility$`](M.visibility),e[`session_appByKey_${M.key}_route$`]("")}),e[`session_workspaceByKey_${T}_unpinnedCoreAppIdsObj$`]({}),e[`session_workspaceByKey_${T}_pinnedAppIds$`](k.map(({id:M})=>M)),e[`session_workspaceByKey_${T}_unpinnedAppIds$`]([])}let h=new Set(m),g=s.filter(_=>!h.has(_)).concat(u),E=new Set(g),L=r.filter(_=>E.has(_)),K=new Set(L),S=L.concat(g.filter(_=>!K.has(_)));e.session_openWorkspaceKeys$(S),e.session_workspaceKeys$(g);for(let _ of m){let k=e[`session_workspaceByKey_${_}_pinnedAppIds$`]()||[],T=e[`session_workspaceByKey_${_}_unpinnedAppIds$`]()||[],M=[...new Set([...k,...T])];e[`session_workspaceByKey_${_}_unpinnedCoreAppIdsObj$`](void 0),e[`session_workspaceByKey_${_}_pinnedAppIds$`](void 0),e[`session_workspaceByKey_${_}_unpinnedAppIds$`](void 0),e[`session_workspaceByKey_${_}_userPk$`](void 0),e[`session_workspaceByKey_${_}_openAppKeys$`](void 0),M.forEach(q=>{(e[`session_workspaceByKey_${_}_appById_${q}_appKeys$`]()||[]).forEach(H=>{e[`session_appByKey_${H}_id$`](void 0),e[`session_appByKey_${H}_visibility$`](void 0),e[`session_appByKey_${H}_route$`](void 0)}),e[`session_workspaceByKey_${_}_appById_${q}_appKeys$`](void 0)})}}e.session_accountUserPks$(d),o.filter(n=>!d.includes(n)).forEach(n=>{e[`session_accountByUserPk_${n}_isReadOnly$`](void 0),e[`session_accountByUserPk_${n}_isLocked$`](void 0),e[`session_accountByUserPk_${n}_profile$`](void 0),e[`session_accountByUserPk_${n}_relays$`](void 0)})}var Tt=C("aModal",function(){let t=te({dialogRef$:null,render:this.props.render,shouldAlwaysDisplay$:this.props.shouldAlwaysDisplay$??this.props.shouldAlwaysDisplay??!1,isOpen$:this.props.isOpen$,close:this.props.close,afterClose:this.props.afterClose});return B(({track:e})=>{e(()=>t.isOpen$.get())?t.dialogRef$().showModal():t.dialogRef$().close()},{after:"rendering"}),this.h`
    <dialog
      ref=${t.dialogRef$}
      data-name='modal'
      closedby='any'
  ...
  `});export{yt as a,ze as b,fe as c,Re as d};
