import{a as oe,b as re,c as ne,d as z,e as D}from"./chunk-NLQW24IH.js";import{a as ee,c as se}from"./chunk-FZKW7XBH.js";import{a as W}from"./chunk-WJCZVXDB.js";import{a as L,e as te,l as ie}from"./chunk-DOTXU7CA.js";import{g as N,l as J}from"./chunk-4YEM5IRY.js";import{a as M}from"./chunk-NYBCEV4T.js";import{b as _,c as I,d as E,e as $,f as O}from"./chunk-TBF35Z4Q.js";import{g as u,i as R,j as C,l as G,n as B,o as g,p as K,q as F,r as V,s as P,t as Y,v as S}from"./chunk-EOHNSKYH.js";var me=/^[^/]+/,fe=/^(:\w|\()/,$e=/:\w|\(/,ge=/^(?::(\w+))?(?:\(([^)]+)\))?/,X=class{constructor(o){this.root=this.createNode(),o&&Object.entries(o).forEach(e=>this.add(...e))}createNode({regex:o,param:e,handler:t}={}){return{regex:o,param:e,handler:t,children:{string:{},regex:{}}}}add(o,e){return this.parseOptim(o,e,this.root),this}parseOptim(o,e,t){if($e.test(o))this.parse(o,e,t);else{let i=t.children.string[o];i?i.handler=e:t.children.string[o]=this.createNode({handler:e})}}parse(o,e,t){if(fe.test(o)){let i=o.match(ge);if(i){let r=t.children.regex[i[0]];r||(r=t.children.regex[i[0]]=this.createNode({regex:i[2]?new RegExp("^"+i[2]):me,param:i[1]})),i[0].length===o.length?r.handler=e:this.parseOptim(o.slice(i[0].length),e,r)}}else{let i=o[0],r=t.children.string[i];r||(r=t.children.string[i]=this.createNode()),this.parse(o.slice(1),e,r)}}find(o){return this.findOptim(o,this.root,{})}findOptim(o,e,t){let i=e.children.string[o];return i&&i.handler!==void 0?{handler:i.handler,params:t}:this.findRecursive(o,e,t)}findRecursive(o,e,t){let i=e.children.string[o[0]];if(i){let r=this.findRecursive(o.slice(1),i,t);if(r)return r}for(let r in e.children.regex)if(i=e.children.regex[r],i.regex){let n=o.match(i.regex);if(n){if(n[0].length===o.length&&i.handler!==void 0)return i.param&&(t[i.param]=decodeURIComponent(n[0])),{handler:i.handler,params:t};{let a=this.findOptim(o.slice(n[0].length),i,t);if(a)return i.param&&(t[i.param]=decodeURIComponent(n[0])),a}}}return null}},ae=X;var ye=new ae({"/:napp(\\+{1,3}\\w+):appPath($|\\/.*)":{},"/app-updates":{mount:"system-views",path:"/app-updates",tag:"napp-updates",loadModule:()=>import("./napp-updates-T6S7GV3Z.js")},"/settings":{mount:"system-views",path:"/settings",tag:"a-settings",loadModule:()=>import("./settings-PFVIGHVV.js")}}),U=ye;function q(){return V("useScrollbarConfig",()=>{let s=document.createElement("div");s.style.cssText=`
      ...
      overflow: scroll;
      visibility: hidden;
    `,document.body.appendChild(s);let o=s.offsetWidth-s.clientWidth;document.body.removeChild(s);let e=o>0;return{width:o,hasClassic:e,hasOverlay:!e,className:e?"classic-scrollbar":"overlay-scrollbar"}})}u("pointerupInterceptor",function(){let{props:{isOpen$:s,isOpenedByLongPress:o}}=this;if(!o)return;let e=g(()=>({isFirstRun$:!0,dialogRef$:null,shouldOpen$(){let t=s();return this.isFirstRun$.get(!1)?(this.isFirstRun$.set(!1),!1):t},onPointerUp(){Promise.resolve().then(()=>this.dialogRef$().hidePopover())}}));return S(({track:t})=>{t(()=>e.shouldOpen$())&&e.dialogRef$().showPopover()},{after:"rendering"}),this.h`<div
    popover
    ref=${e.dialogRef$}
  ...
  />`});u("aMenu",function(){let s=g({id$:this.props.id$||this.props.id||"a"+Math.random().toString(36).slice(2)+Math.random().toString(36).slice(2),dialogRef$:null,render:this.props.render,shouldAlwaysDisplay$:this.props.shouldAlwaysDisplay$??this.props.shouldAlwaysDisplay??!1,isOpen$:this.props.isOpen$,close:this.props.close,afterClose:this.props.afterClose,style$:this.props.style$??this.props.style??"",anchorRef$:this.props.anchorRef$,fallbackPositioningStyle$:"",fallbackOffset$:this.props.fallbackOffset??{}}),o=g(()=>({isOpen$:s.isOpen$,isOpenedByLongPress:this.props.isOpenedByLongPress??!1}));return S(({track:e})=>{let t=e(()=>s.isOpen$.get()),i=e(()=>s.anchorRef$());!t||!i||CSS.supports("position-anchor","--test")||(s.fallbackPositioningStyle$(`
    ...
    `),setTimeout(()=>{requestAnimationFrame(()=>{let r=i.getBoundingClientRect(),n=s.dialogRef$().getBoundingClientRect(),a=window.innerWidth>window.innerHeight,p=6,l,d;if(a)l=Math.max(p,r.left-n.width-p),d=r.top;else{l=r.left;let y=n.height>0?n.height:100;d=Math.max(p,r.top-y-p)}let b=s.fallbackOffset$(),c=(a?b.landscape:b.portrait)||{};l+=c.x||0,d+=c.y||0,s.fallbackPositioningStyle$(`
          & {
            left: ${l}px;
            top: ${d}px;
            right: auto;
  ...
  />`});u("icon-shopping-bag",function(){let s=g({path$:["M6.331 8h11.339a2 2 0 0 1 1.977 2.304l-1.255 8.152a3 3 0 0 1 -2.966 2.544h-6.852a3 3 0 0 1 -2.965 -2.544l-1.255 -8.152a2 2 0 0 1 1.977 -2.304","M9 11v-5a3 3 0 0 1 6 0v5"],viewBox$:"2 2 20 20"});return this.h`<a-svg
    props=${{...s,...this.props}}
  />`});u("toolbar-more-menu",function(){let{isHidden$:s}=K("toolbarState",{isHidden$:!1}),{openApp:o}=K("useAppRouter"),{isOpen$:e,anchorRef$:t}=g({isOpen$:!1,anchorRef$:null}),i=M(),{session_unread_appUpdateCount$:r}=_(localStorage),n=g({isOpen$:e,anchorRef$:t,close:()=>e.set(!1),fallbackOffset:{portrait:{x:-119,y:5},landscape:{x:-17,y:-15}},style$:()=>{let a=`& {
  ...
  `});u("aScreen",function(){ne(),H();let{isSystemRoute$:s}=Z(),o=_(localStorage);S(({cleanup:n})=>{let a=new BroadcastChannel("44billion_subdomain_nav");n(()=>a.close()),a.onmessage=p=>{let{href:l,userPk:d}=p.data;if(!l)return;let b;d&&(b=(o.session_openWorkspaceKeys$()||[]).find(c=>o[`session_workspaceByKey_${c}_userPk$`]()===d));try{let{openApp:c}=K("useAppRouter");c(l,b)}catch(c){console.error("Subdomain nav failed",c)}}});let e=o.config_isSingleWindow$,{isHidden$:t}=K("toolbarState",{isHidden$:!1}),i=B(()=>`
    /* @scope { */
    #screen {
      &${I.defaultTheme}
  ...
  `),r=Y("unifiedToolbarRef",null);return this.h`
    <div id="screen" class=${{"multi-window":!e(),[E.defaultTheme]:!0}}>
      <style>${i()}</style>
      <div id='workspaces'>
        <a-windows id='windows' />
        <system-views id='system-views' />
      </div>
      <unified-toolbar ref=${r} id='unified-toolbar' />
      <toolbar-restore-button />
    </div>
  `});u("system-views",function(){return this.h`
    <a-route props=${{path:"/settings"}} />
    <a-route props=${{path:"/app-updates"}} />
  `});u("aWindows",function(){let{session_openWorkspaceKeys$:s}=_(localStorage),o=C([]);S(({track:t})=>{let i=t(()=>s());o(r=>r.concat(i.filter(n=>!r.includes(n))))});let e=B(()=>s().reduce((t,i,r)=>({...t,[i]:r+1}),{}));return this.h`
  ...
  `});u("workspaceWindow",function(){let s=_(sessionStorage),{[`session_workspaceByKey_${this.props.workspaceKey}_openAppKeys$`]:o}=s,e=C([]);S(({track:i})=>{let r=i(()=>o())??[];e(n=>n.concat(r.filter(a=>!n.includes(a))))});let t=B(()=>(o()??[]).reduce((i,r,n)=>({...i,[r]:`${this.props.mruRankByWsKey$()[this.props.workspaceKey]}-${n+1}`}),{}))();return this.h`
    ${e().map(i=>{let r=t[i];return this.h({key:i})`
      <app-window key=${i} props=${{appKey:i,wsKey:this.props.workspaceKey,mruRank:r}} />
      `})}
  `});u("appWindow",function(){let s=_(localStorage),o=_(sessionStorage),{[`session_appByKey_${this.props.appKey}_id$`]:e,[`session_appByKey_${this.props.appKey}_route$`]:t,[`session_workspaceByKey_${this.props.wsKey}_userPk$`]:i}=s,{[`session_appByKey_${this.props.appKey}_visibility$`]:r}=o,n=B(()=>(i()||"")&&oe(i(),50)),a=B(()=>{let v=i(),w=e();return!v||!w?null:s[`session_subdomainByUserAndApp_${v}_${w}$`]()}),p=B(()=>r()==="closed"),l=C(null),d=C("about:blank"),b=C(null),c=C("about:blank"),{cachingProgress$:y}=P("<napp-assets-caching-progress-bar>",{cachingProgress$:{}}),{requestVaultMessage:h}=D(),f=K("<permission-dialog>"),{requestPermission:m}=f,{openApp:x}=K("useAppRouter");if(S(async({track:v,cleanup:w})=>{let[k,A]=v(()=>[p(),l()]);if(k){y({}),l(null),c("about:blank"),b(null),d("about:blank");return}if(!A)return;if(a()==null){let j=s.session_subdomainNextId$()??0;s.session_subdomainNextId$(j+1),s[`session_subdomainByUserAndApp_${i()}_${e()}$`](String(j)),s[`session_subdomainToApp_${j}$`]({appId:e(),userPk:i()})}let T=t()||"";T&&t("");let Q=new AbortController;w(()=>Q.abort()),await re(n(),e(),a(),T,l(),b(),c,y,h,m,x,{signal:Q.signal,isSingleNapp:!1}),d(`//${a()}.${window.location.host}/~~napp`)},{after:"rendering"}),!p())return this.h`
    <div
      style=${`
        background-color: ${$.colors.bg};
      `}
  ...
  `});u("unifiedToolbar",function(){let s=q();return this.h`
    <style>${`
      /* @scope { */
      #unified-toolbar {
  ...
  `});u("toolbarActiveAvatar",function(){return P("<a-menu>",{isOpen$:!1,anchorRef$:null,open(){this.isOpen$(!0)},close(){this.isOpen$(!1)},toggle(){this.isOpen$(s=>!s)}}),this.h`
    <toolbar-menu />
    <toolbar-avatar />
  `});u("toolbarMenu",function(){let s=_(localStorage),{session_openWorkspaceKeys$:o,session_workspaceKeys$:e}=s,{close:t}=P("<a-menu>"),i=z(),{requestVaultMessage:r}=D(),n=C({}),a=C({}),p=s.session_defaultUserPk$,l=B(()=>{let m=[],x={};e().forEach(w=>{let k=s[`session_workspaceByKey_${w}_userPk$`]();if(k!=null){let A=s[`session_accountByUserPk_${k}_profile$`](),T=s[`session_accountByUserPk_${k}_isLocked$`]();x[k]===void 0&&(x[k]=0),x[k]++,m.push({userPk:k,wsKey:w,profile:A,name:A?.name||A?.npub||k!==p()&&N(k)||"Default User",isLocked:T,index:x[k],totalCount:x[k]})}});let v={};return m.forEach(w=>{v[w.userPk]===void 0&&(v[w.userPk]=0),v[w.userPk]++}),m.forEach(w=>{w.totalCount=v[w.userPk]}),m}),d=B(()=>{let m=o()[0];return s[`session_workspaceByKey_${m}_userPk$`]()}),{disableStartAtVaultHomeWorkaroundThisTime:b}=K("vaultMessenger"),c=R(async(m,x,v)=>{if(m!==d()){let w=[...o()],k=[x,...w.filter(A=>A!==x)];s.session_openWorkspaceKeys$(k)}if(v){let w=`${m}-${x}`;n({...n(),[w]:!0}),a({...a(),[w]:null});try{let k=N(m),A=await r({code:"UNLOCK_ACCOUNT",payload:{pubkey:k}},{timeout:12e4,instant:!0});if(A.error||!A.payload?.isRouteReady)throw new Error(A.error?.message||"Failed to unlock account");t(),b(),i.open()}catch(k){a({...a(),[w]:k.message||"Error unlocking"}),setTimeout(()=>{a(A=>{let T={...A};return delete T[w],T})},3e3)}finally{n(k=>{let A={...k};return delete A[w],A})}}else t()}),y=R(()=>{t(),i.open()}),h=P("<a-menu>"),f=g({render:R(function(){return this.h`<div id='user-selection-menu'>
        <style>${`
          #user-selection-menu {
            display: flex;
            flex-direction: column;
        ...
        `}</style>
        ${l().map(m=>{let x=`${m.userPk}-${m.wsKey}`,v=n()[x],w=a()[x];return this.h({key:x})`<div
            class=${{"user-item":!0,active:m.userPk===d(),unlocking:v}}
        ...
        position: fixed;
        z-index: 1000;
      }`,...h});return this.h`<a-menu props=${f} />`});u("toolbarAvatar",function(){let s=_(localStorage),{session_openWorkspaceKeys$:o,session_workspaceKeys$:e}=s,t=B(()=>{let c=o()[0];return s[`session_workspaceByKey_${c}_userPk$`]()}),i=B(()=>{let c=t();return c?s[`session_accountByUserPk_${c}_isLocked$`]():!1}),r=B(()=>{let c=t(),y=o()[0];if(!c||!y)return{index:1,showBadge:!1};let h=0,f=0;for(let m of e())s[`session_workspaceByKey_${m}_userPk$`]()===c&&f++;for(let m of e())if(s[`session_workspaceByKey_${m}_userPk$`]()===c&&(h++,m===y))break;return{index:h,showBadge:f>1}}),{toggle:n,close:a,anchorRef$:p}=P("<a-menu>"),l=z(),d=B(()=>t()!==s.session_defaultUserPk$()||o().length>1);S(({track:c})=>{c(()=>d())||a()});let b=R(()=>{if(d())return n();l.open()});return this.h`<div
    ref=${p}
    onclick=${b}
    style=${`
  ...
  `});u("toolbarPinnedApps",function(){let s=_(localStorage),{session_openWorkspaceKeys$:o}=s,e=B(()=>{let t=o()[0];return(s[`session_workspaceByKey_${t}_pinnedAppIds$`]()||[]).reduce((r,n,a)=>{let p=a+1;return s[`session_workspaceByKey_${t}_appById_${n}_appKeys$`]().forEach(l=>{r.push({appId:n,appKey:l,appIndex:p})}),r},[])});return this.h`${e().map(t=>this.h({key:t.appKey})`<toolbar-app-launcher key=${t.appKey} props=${t} />`)}`});u("toolbarUnpinnedApps",function(){let s=_(localStorage),{session_openWorkspaceKeys$:o}=s,e=B(()=>{let t=o()[0],i=(s[`session_workspaceByKey_${t}_pinnedAppIds$`]()||[]).length;return(s[`session_workspaceByKey_${t}_unpinnedAppIds$`]()||[]).reduce((n,a,p)=>{let l=p+1+i;return s[`session_workspaceByKey_${t}_appById_${a}_appKeys$`]().forEach(d=>{n.push({appId:a,appKey:d,appIndex:l})}),n},[])});return this.h`
    <app-launchers-menu />
    ${e().map(t=>this.h({key:t.appKey})`<toolbar-app-launcher key=${t.appKey} props=${t} />`)}
  `});u("appLaunchersMenu",function(){let s=P("<a-menu>"),o=_(localStorage),e=_(sessionStorage),{requestConfirmation:t}=K("<confirmation-dialog>"),i=g(()=>({...s,openApp(){let{visibility:r,key:n,workspaceKey:a}=this.app$();if(r==="open")throw new Error("App is already open");this.close(),e[`session_appByKey_${n}_visibility$`]("open"),e[`session_workspaceByKey_${a}_openAppKeys$`]((p=[],l)=>{let d=p.indexOf(n);return d!==-1&&p.splice(d,1),p.unshift(n),p[l]=Math.random(),p})},bringToFirst(){let{visibility:r,key:n,workspaceKey:a}=this.app$(),p=e[`session_workspaceByKey_${a}_openAppKeys$`]()??[];if(r!=="open")throw new Error("Can only bring to first when app is open");if(p[0]===n)throw new Error("App is already first");this.close();let l;e[`session_workspaceByKey_${a}_openAppKeys$`]((d,b)=>(l=d.indexOf(n),l>-1&&(d.splice(l,1),d.unshift(n),d[b]=Math.random()),d))},minimizeApp(){let{visibility:r,key:n,workspaceKey:a}=this.app$();if(r!=="open")throw new Error("Can only minimize an open app");this.close();let p;e[`session_appByKey_${n}_visibility$`]("minimized"),e[`session_workspaceByKey_${a}_openAppKeys$`]((l,d)=>(p=l.indexOf(n),p>-1&&(l.splice(p,1),l[d]=Math.random()),l))},closeApp(){let{visibility:r,key:n,workspaceKey:a}=this.app$();if(r==="closed")throw new Error("App is already closed");this.close(),e[`session_appByKey_${n}_visibility$`]("closed"),e[`session_workspaceByKey_${a}_openAppKeys$`]((p,l)=>{let d=p.indexOf(n);return d!==-1&&(p.splice(d,1),p[l]=Math.random()),p})},removeApp({isDeleteStep:r=!1}={}){let{id:n,key:a,workspaceKey:p}=this.app$(),l=o[`session_workspaceByKey_${p}_appById_${n}_appKeys$`]();if(!r&&l.length<=1)throw new Error("Cannot remove the last instance of an app");r||this.close(),e[`session_workspaceByKey_${p}_openAppKeys$`]((c,y)=>{if(!c)return c;let h=c.indexOf(a);return h!==-1&&(c.splice(h,1),c[y]=Math.random()),c});let d=l.filter(c=>c!==a);o[`session_workspaceByKey_${p}_appById_${n}_appKeys$`](d),o[`session_appByKey_${a}_id$`](void 0),e[`session_appByKey_${a}_visibility$`](void 0),o[`session_appByKey_${a}_route$`](void 0);let b=!1;for(let c of o.session_workspaceKeys$())if(b=(o[`session_workspaceByKey_${c}_appById_${n}_appKeys$`]()??[]).some(y=>y!==a),b)break;b||(o[`session_appById_${n}_icon$`](void 0),o[`session_appById_${n}_name$`](void 0),o[`session_appById_${n}_description$`](void 0),o[`session_appById_${n}_relayHints$`](void 0))},async maybeClearAppStorage(){let{id:r,workspaceKey:n}=this.app$(),a=o[`session_workspaceByKey_${n}_userPk$`](),p=o.session_workspaceKeys$().filter(c=>c!==n),l=!0,d=!0;for(let c of p)if(o[`session_workspaceByKey_${c}_appById_${r}_appKeys$`]()?.length>0&&(d=!1,o[`session_workspaceByKey_${c}_userPk$`]()===a)){l=!1;break}if(l){let c=o[`session_subdomainByUserAndApp_${a}_${r}$`]();c!=null&&(await b(c),o[`session_subdomainByUserAndApp_${a}_${r}$`](void 0),o[`session_subdomainToApp_${c}$`](void 0))}d&&await(await ie.create(r)).clearAppFiles();function b(c){let y=Promise.withResolvers(),h=document.createElement("iframe");h.style.display="none";let f,m=()=>{f&&clearTimeout(f),window.removeEventListener("message",v),document.body.removeChild(h)},x=`${window.location.protocol}//${c}.${window.location.host}`,v=w=>{w.origin===x&&(w.data.code==="DATA_CLEARED"&&(m(),y.resolve()),w.data.code==="DATA_CLEAR_ERROR"&&(m(),y.reject(w.data.error)))};return window.addEventListener("message",v),h.src=`${x}/~~napp#clear`,document.body.appendChild(h),f=setTimeout(()=>{m(),y.reject(new Error("Data clear timeout"))},5e3),y.promise}},async deleteApp(){try{await t({confirmText:"Delete"})}catch(r){r.code!=="DENIED_BY_USER"&&console.error(r);return}await this._deleteApp()},async _deleteApp(){let{id:r,workspaceKey:n}=this.app$();if(o[`session_workspaceByKey_${n}_appById_${r}_appKeys$`]().length!==1)throw new Error("Can only delete an app that has a single instance");this.removeApp({isDeleteStep:!0}),this.close(),o[`session_workspaceByKey_${n}_pinnedAppIds$`](p=>(p??[]).filter(l=>l!==r)),o[`session_workspaceByKey_${n}_unpinnedAppIds$`](p=>(p??[]).filter(l=>l!==r)),o[`session_workspaceByKey_${n}_appById_${r}_appKeys$`](void 0),await this.maybeClearAppStorage()},render:R(function(){let{openApp:r,bringToFirst:n,minimizeApp:a,closeApp:p,removeApp:l,deleteApp:d,app$:b}=i,{id:c,key:y,visibility:h,workspaceKey:f}=b(),m=e[`session_workspaceByKey_${f}_openAppKeys$`]()??[],x=o[`session_workspaceByKey_${f}_appById_${c}_appKeys$`]();return this.h`<div id='scope_pfgf892'>
        <style>${`
          #scope_pfgf892 {
            & > div {
        ...
        <div class=${{invisible:h==="open"}}>
          ...
          <div class='menu-label' onclick=${r}>${h==="closed"?"Open":"Maximize"}</div>
        </div>
        ...
        display: flex;
        flex-direction: column;
      `;return`& { ${CSS.supports("position-anchor","--test")?r:n} ${a} }`},anchorRef$:()=>i.app$()?.ref}));return this.h`<a-menu props=${i} />`});u("toolbarAppLauncher",function(){let s=_(localStorage),o=_(sessionStorage),e=F("hardcoded_newAppIdsObj"),t=G(this.props.appIndex),i=C(),r=B(()=>({id:this.props.appId,key:this.props.appKey,workspaceKey:s.session_openWorkspaceKeys$()[0],index:t(),visibility:o[`session_appByKey_${this.props.appKey}_visibility$`]()??"closed",icon:s[`session_appByKey_${this.props.appKey}_icon$`](),isNew:!!e()[this.props.appId],ref:i()})),{toggleMenu:n,app$:a}=P("<a-menu>"),p=()=>n({...r()}),l=B(()=>a().key===r().key?"--app-launchers-menu":"none"),d=B(()=>{switch(r().visibility){case"open":return $.colors.bg3Primary;case"minimized":return $.colors.bg3Secondary;case"closed":default:return $.colors.bg3}});return this.h`<div
    ref=${i}
    onclick=${p}
  ...
  `});u("permissionDialogCard",function(){let s=_(localStorage),o=P("<permission-dialog-stack>"),e=g(()=>({req$:this.props.req$,index$:this.props.index$,resolveCurrent(i){return o.resolveCurrent(i,this.req$())},isButtonsDisabled$:!1,allow(){return this.isButtonsDisabled$(!0),this.resolveCurrent(!0)},deny(){return this.isButtonsDisabled$(!0),this.resolveCurrent(!1)},permissionText$(){let i=this.req$();return o.getPemissionText(i.name,i.eKind,i.meta)},appName$(){let i=this.req$(),{[`session_appById_${i.app.id}_name$`]:r}=s,n=r();return i.app.name||n||i.app.alias||i.app.napp||"App"}})),t=g(()=>({app$:()=>({id:e.req$().app.id,index:"?"})}));return this.h`
    <style>${`
  ...
  `});u("multi-napp",function(){return S(()=>{W.initCleanupJob(),W.initUpdateCheckJob()}),M(U),z(()=>({isOpen$:!1,open(){this.isOpen$(!0)},close(){this.isOpen$(!1)}})),this.h`
    <vault-modal />
    <permission-dialog />
    <confirmation-dialog />
    <a-screen />
