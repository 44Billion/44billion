import{a as x,b as j,c as N,d as ie,e as re,f as U,g as L,h as g,i as O,j as T,k as Z}from"./chunk-5CSSZ5X6.js";import{A as M,B as X,E as D,H as se,J as te,L as oe,h as u,j as R,k as B,m as E,n as G,o as w,p as y,q as P,r as q,s as Y,t as A,u as J,v as ee,w as K}from"./chunk-6C3T4FJN.js";function he(e){let{onPopState:t}=P("_f_useLocation",{url$:()=>new URL(window.location),state$(){return this.url$()&&history.state},params$(){return e?.find?.(this.url$().pathname.replace(/\/+$/,""))?.params??{}},replaceState(...o){history.replaceState(...o),o[2]&&location.href!==this.url$().href&&this.url$(new URL(window.location))},pushState(...o){if(!o[2]||location.href===this.url$().href)throw new Error("Use replaceState when keeping url");history.pushState(...o),this.url$(new URL(window.location))},onPopState(){this.url$(new URL(window.location))}});fe(t)}function z(e){return e&&he(e),P("_f_useLocation")}function fe(e){K(({cleanup:t})=>{let o=new AbortController;t(()=>o.abort()),window.addEventListener("popstate",e,{signal:o.signal})})}var $e=/^[^/]+/,me=/^(:\w|\()/,ge=/:\w|\(/,ye=/^(?::(\w+))?(?:\(([^)]+)\))?/,F=class{constructor(t){this.root=this.createNode(),t&&Object.entries(t).forEach(o=>this.add(...o))}createNode({regex:t,param:o,handler:i}={}){return{regex:t,param:o,handler:i,children:{string:{},regex:{}}}}add(t,o){return this.parseOptim(t,o,this.root),this}parseOptim(t,o,i){if(ge.test(t))this.parse(t,o,i);else{let s=i.children.string[t];s?s.handler=o:i.children.string[t]=this.createNode({handler:o})}}parse(t,o,i){if(me.test(t)){let s=t.match(ye);if(s){let r=i.children.regex[s[0]];r||(r=i.children.regex[s[0]]=this.createNode({regex:s[2]?new RegExp("^"+s[2]):$e,param:s[1]})),s[0].length===t.length?r.handler=o:this.parseOptim(t.slice(s[0].length),o,r)}}else{let s=t[0],r=i.children.string[s];r||(r=i.children.string[s]=this.createNode()),this.parse(t.slice(1),o,r)}}find(t){return this.findOptim(t,this.root,{})}findOptim(t,o,i){let s=o.children.string[t];return s&&s.handler!==void 0?{handler:s.handler,params:i}:this.findRecursive(t,o,i)}findRecursive(t,o,i){let s=o.children.string[t[0]];if(s){let r=this.findRecursive(t.slice(1),s,i);if(r)return r}for(let r in o.children.regex)if(s=o.children.regex[r],s.regex){let n=t.match(s.regex);if(n){if(n[0].length===t.length&&s.handler!==void 0)return s.param&&(i[s.param]=decodeURIComponent(n[0])),{handler:s.handler,params:i};{let a=this.findOptim(t.slice(n[0].length),s,i);if(a)return s.param&&(i[s.param]=decodeURIComponent(n[0])),a}}}return null}},ne=F;var we=new ne({"/:napp(\\+{1,3}\\w+):appPath($|\\/.*)":{}}),W=we;function H(){return Y("useScrollbarConfig",()=>{let e=document.createElement("div");e.style.cssText=`
      ...
      overflow: scroll;
      visibility: hidden;
    `,document.body.appendChild(e);let t=e.offsetWidth-e.clientWidth;document.body.removeChild(e);let o=t>0;return{width:t,hasClassic:o,hasOverlay:!o,className:o?"classic-scrollbar":"overlay-scrollbar"}})}u("pointerupInterceptor",function(){let{props:{isOpen$:e,isOpenedByLongPress:t}}=this;if(!t)return;let o=y(()=>({isFirstRun$:!0,dialogRef$:null,shouldOpen$(){let i=e();return this.isFirstRun$.get(!1)?(this.isFirstRun$.set(!1),!1):i},onPointerUp(){requestIdleCallback(()=>this.dialogRef$().hidePopover())}}));return K(({track:i})=>{i(()=>o.shouldOpen$())&&o.dialogRef$().showPopover()},{after:"rendering"}),this.h`<div
    popover
    ref=${o.dialogRef$}
  ...
  />`});u("aMenu",function(){let e=y({id$:this.props.id$||this.props.id||"a"+Math.random().toString(36).slice(2)+Math.random().toString(36).slice(2),dialogRef$:null,render:this.props.render,shouldAlwaysDisplay$:this.props.shouldAlwaysDisplay$??this.props.shouldAlwaysDisplay??!1,isOpen$:this.props.isOpen$,close:this.props.close,afterClose:this.props.afterClose,style$:this.props.style$??this.props.style??"",anchorRef$:this.props.anchorRef$,fallbackPositioningStyle$:""}),t=y(()=>({isOpen$:e.isOpen$,isOpenedByLongPress:this.props.isOpenedByLongPress??!1}));return K(({track:o})=>{let i=o(()=>e.isOpen$.get()),s=o(()=>e.anchorRef$());!i||!s||CSS.supports("position-anchor","--test")||(e.fallbackPositioningStyle$(`
    ...
    `),setTimeout(()=>{requestAnimationFrame(()=>{let r=s.getBoundingClientRect(),n=e.dialogRef$().getBoundingClientRect(),a=window.innerWidth>window.innerHeight,p=6,l,d;if(a)l=Math.max(p,r.left-n.width-p),d=r.top;else{l=r.left;let m=n.height>0?n.height:100;d=Math.max(p,r.top-m-p)}e.fallbackPositioningStyle$(`
          & {
            left: ${l}px;
            top: ${d}px;
            right: auto;
  ...
  `),o=J("unifiedToolbarRef",null);return this.h`
    <div id="screen" class=${{"multi-window":!e(),[L.defaultTheme]:!0}}>
      <style>${t()}</style>
      <div id='workspaces'>
  ...
  `});u("workspaceWindow",function(){let e=x(localStorage),{[`session_workspaceByKey_${this.props.workspaceKey}_openAppKeys$`]:t}=e,o=B([]);K(({track:s})=>{let r=s(()=>t());o(n=>n.concat(r.filter(a=>!n.includes(a))))});let i=w(()=>(t()??[]).reduce((s,r,n)=>({...s,[r]:`${this.props.mruRankByWsKey$()[this.props.workspaceKey]}-${n+1}`}),{}))();return this.h`
    ${o().map(s=>{let r=i[s];return this.h({key:s})`
      ...
      `})}
  `});u("appWindow",function(){let e=x(localStorage),{[`session_appByKey_${this.props.appKey}_id$`]:t,[`session_appByKey_${this.props.appKey}_visibility$`]:o,[`session_appByKey_${this.props.appKey}_route$`]:i,[`session_workspaceByKey_${this.props.wsKey}_userPk$`]:s}=e,r=w(()=>(s()||"")&&X(s(),50)),n=w(()=>D(t(),r())),a=w(()=>o()==="closed"),p=B(null),l=B("about:blank"),d=B(null),m=B("about:blank"),{cachingProgress$:c}=A("<napp-assets-caching-progress-bar>",{cachingProgress$:{}}),{requestVaultMessage:$}=Z(),f=P("<permission-dialog>"),{requestPermission:_}=f,{openApp:h}=P("useAppRouter");if(K(async({track:b,cleanup:C})=>{let[k,v]=b(()=>[a(),p()]);if(k){c({}),p(null),m("about:blank"),d(null),l("about:blank");return}if(!v)return;let S=i()||"";S&&i("");let I=new AbortController;C(()=>I.abort()),await ie(r(),t(),n(),S,p(),d(),m,c,$,_,h,{signal:I.signal,isSingleNapp:!1}),l(`//${n()}.${window.location.host}/~~napp`)},{after:"rendering"}),!a())return this.h`
    <div
      style=${`
        background-color: ${g.colors.bg};
      `}
  ...
  `});u("unifiedToolbar",function(){let e=H();return this.h`
    ...
    <toolbar-active-avatar />
    <toolbar-app-list />
  `});u("toolbarActiveAvatar",function(){return A("<a-menu>",{isOpen$:!1,anchorRef$:null,open(){this.isOpen$(!0)},close(){this.isOpen$(!1)},toggle(){this.isOpen$(e=>!e)}}),this.h`
    <toolbar-menu />
    <toolbar-avatar />
  `});u("toolbarMenu",function(){let e=x(localStorage),{session_openWorkspaceKeys$:t,session_workspaceKeys$:o}=e,{close:i}=A("<a-menu>"),s=T(),{requestVaultMessage:r}=Z(),n=B({}),a=B({}),p=e.session_defaultUserPk$,l=w(()=>{let h=[],b={};o().forEach(k=>{let v=e[`session_workspaceByKey_${k}_userPk$`]();if(v!=null){let S=e[`session_accountByUserPk_${v}_profile$`](),I=e[`session_accountByUserPk_${v}_isLocked$`]();b[v]===void 0&&(b[v]=0),b[v]++,h.push({userPk:v,wsKey:k,profile:S,name:S?.name||S?.npub||v!==p()&&M(v)||"Default User",isLocked:I,index:b[v],totalCount:b[v]})}});let C={};return h.forEach(k=>{C[k.userPk]===void 0&&(C[k.userPk]=0),C[k.userPk]++}),h.forEach(k=>{k.totalCount=C[k.userPk]}),h}),d=w(()=>{let h=t()[0];return e[`session_workspaceByKey_${h}_userPk$`]()}),{disableStartAtVaultHomeWorkaroundThisTime:m}=P("vaultMessenger"),c=R(async(h,b,C)=>{if(h!==d()){let k=[...t()],v=[b,...k.filter(S=>S!==b)];e.session_openWorkspaceKeys$(v)}if(C){let k=`${h}-${b}`;n({...n(),[k]:!0}),a({...a(),[k]:null});try{let v=M(h),S=await r({code:"UNLOCK_ACCOUNT",payload:{pubkey:v}},{timeout:12e4,instant:!0});if(S.error||!S.payload?.isRouteReady)throw new Error(S.error?.message||"Failed to unlock account");i(),m(),s.open()}catch(v){a({...a(),[k]:v.message||"Error unlocking"}),setTimeout(()=>{a(S=>{let I={...S};return delete I[k],I})},3e3)}finally{n(v=>{let S={...v};return delete S[k],S})}}else i()}),$=R(()=>{i(),s.open()}),f=A("<a-menu>"),_=y({render:R(function(){return this.h`<div id='user-selection-menu'>
        <style>${`
          #user-selection-menu {
            display: flex;
            flex-direction: column;
        ...
        `}</style>
        ${l().map(h=>{let b=`${h.userPk}-${h.wsKey}`,C=n()[b],k=a()[b];return this.h({key:b})`<div
            class=${{"user-item":!0,active:h.userPk===d(),unlocking:C}}
          ...
          >
            ...
            <div>
              ...
              ${h.isLocked?this.h`<div class=${k?"user-unlock-error":"user-unlock-hint"}>
                    ${k||"Touch to unlock"}
                  </div>`:""}
            </div>
          </div>`})}
        <div class="add-user-button" onclick=${$}>
      ...
      }`,...f});return this.h`<a-menu props=${_} />`});u("toolbarAvatar",function(){let e=x(localStorage),{session_openWorkspaceKeys$:t,session_workspaceKeys$:o}=e,i=w(()=>{let c=t()[0];return e[`session_workspaceByKey_${c}_userPk$`]()}),s=w(()=>{let c=i();return c?e[`session_accountByUserPk_${c}_isLocked$`]():!1}),r=w(()=>{let c=i(),$=t()[0];if(!c||!$)return{index:1,showBadge:!1};let f=0,_=0;for(let h of o())e[`session_workspaceByKey_${h}_userPk$`]()===c&&_++;for(let h of o())if(e[`session_workspaceByKey_${h}_userPk$`]()===c&&(f++,h===$))break;return{index:f,showBadge:_>1}}),{toggle:n,close:a,anchorRef$:p}=A("<a-menu>"),l=T(),d=w(()=>i()!==e.session_defaultUserPk$()||t().length>1);K(({track:c})=>{c(()=>d())||a()});let m=R(()=>{if(d())return n();l.open()});return this.h`<div
    ref=${p}
    onclick=${m}
    style=${`
  ...
  </div>`});u("toolbarAppList",function(){return A("<a-menu>",()=>({isOpenedByLongPress:!1,isOpen$:!1,open(){this.isOpen$(!0)},close(){this.isOpen$(!1)},app$:{key:""},toggleMenu(e){this.app$().key===e.key?(this.app$(e),this.isOpen$(o=>!o)):(this.close(),window.requestIdleCallback(()=>{this.app$(e),this.open()}))}}),{isStatic:!1}),this.h`
    <toolbar-pinned-apps />
  ...
  `});u("appLaunchersMenu",function(){let e=A("<a-menu>"),t=x(localStorage),o=y(()=>({...e,openApp(){let{visibility:i,key:s,workspaceKey:r}=this.app$();if(i==="open")throw new Error("App is already open");this.close(),t[`session_appByKey_${s}_visibility$`]("open"),t[`session_workspaceByKey_${r}_openAppKeys$`]((n,a)=>{let p=n.indexOf(s);return p!==-1&&n.splice(p,1),n.unshift(s),n[a]=Math.random(),n})},bringToFirst(){let{visibility:i,key:s,workspaceKey:r}=this.app$(),n=t[`session_workspaceByKey_${r}_openAppKeys$`]();if(i!=="open")throw new Error("Can only bring to first when app is open");if(n[0]===s)throw new Error("App is already first");this.close();let a;t[`session_workspaceByKey_${r}_openAppKeys$`]((p,l)=>(a=p.indexOf(s),a>-1&&(p.splice(a,1),p.unshift(s),p[l]=Math.random()),p))},minimizeApp(){let{visibility:i,key:s,workspaceKey:r}=this.app$();if(i!=="open")throw new Error("Can only minimize an open app");this.close();let n;t[`session_appByKey_${s}_visibility$`]("minimized"),t[`session_workspaceByKey_${r}_openAppKeys$`]((a,p)=>(n=a.indexOf(s),n>-1&&(a.splice(n,1),a[p]=Math.random()),a))},closeApp(){let{visibility:i,key:s,workspaceKey:r}=this.app$();if(i==="closed")throw new Error("App is already closed");this.close(),t[`session_appByKey_${s}_visibility$`]("closed"),t[`session_workspaceByKey_${r}_openAppKeys$`]((n,a)=>{let p=n.indexOf(s);return p!==-1&&(n.splice(p,1),n[a]=Math.random()),n})},removeApp({isDeleteStep:i=!1}={}){let{id:s,key:r,workspaceKey:n}=this.app$(),a=t[`session_workspaceByKey_${n}_appById_${s}_appKeys$`]();if(!i&&a.length<=1)throw new Error("Cannot remove the last instance of an app");i||this.close(),t[`session_workspaceByKey_${n}_openAppKeys$`]((d,m)=>{let c=d.indexOf(r);return c!==-1&&(d.splice(c,1),d[m]=Math.random()),d});let p=a.filter(d=>d!==r);t[`session_workspaceByKey_${n}_appById_${s}_appKeys$`](p),t[`session_appByKey_${r}_id$`](void 0),t[`session_appByKey_${r}_visibility$`](void 0),t[`session_appByKey_${r}_route$`](void 0);let l=!1;for(let d of t.session_workspaceKeys$())if(l=t[`session_workspaceByKey_${d}_appById_${s}_appKeys$`]().some(m=>m!==r),l)break;l||(t[`session_appById_${s}_icon$`](void 0),t[`session_appById_${s}_name$`](void 0),t[`session_appById_${s}_description$`](void 0),t[`session_appById_${s}_relayHints$`](void 0))},async maybeClearAppStorage(){let{id:i,workspaceKey:s}=this.app$(),r=t[`session_workspaceByKey_${s}_userPk$`](),n=t.session_workspaceKeys$().filter(d=>d!==s),a=!0,p=!0;for(let d of n)if(t[`session_workspaceByKey_${d}_appById_${i}_appKeys$`]()?.length>0&&(p=!1,t[`session_workspaceByKey_${d}_userPk$`]()===r)){a=!1;break}if(a){let d=X(r,50),m=D(i,d);await l(m)}p&&await(await N.create(i)).clearAppFiles();function l(d){let m=Promise.withResolvers(),c=document.createElement("iframe");c.style.display="none";let $,f=()=>{$&&clearTimeout($),window.removeEventListener("message",h),document.body.removeChild(c)},_=`${window.location.protocol}//${d}.${window.location.host}`,h=b=>{b.origin===_&&(b.data.code==="DATA_CLEARED"&&(f(),m.resolve()),b.data.code==="DATA_CLEAR_ERROR"&&(f(),m.reject(b.data.error)))};return window.addEventListener("message",h),c.src=`${_}/~~napp#clear`,document.body.appendChild(c),$=setTimeout(()=>{f(),m.reject(new Error("Data clear timeout"))},5e3),m.promise}},async deleteApp(){let{id:i,workspaceKey:s}=this.app$();if(t[`session_workspaceByKey_${s}_appById_${i}_appKeys$`]().length!==1)throw new Error("Can only delete an app that has a single instance");this.removeApp({isDeleteStep:!0}),this.close(),await this.maybeClearAppStorage(),t[`session_workspaceByKey_${s}_pinnedAppIds$`](n=>(n??[]).filter(a=>a!==i)),t[`session_workspaceByKey_${s}_unpinnedAppIds$`](n=>(n??[]).filter(a=>a!==i)),t[`session_workspaceByKey_${s}_appById_${i}_appKeys$`](void 0)},render:R(function(){let{openApp:i,bringToFirst:s,minimizeApp:r,closeApp:n,removeApp:a,deleteApp:p,app$:l}=o,{id:d,key:m,visibility:c,workspaceKey:$}=l(),f=t[`session_workspaceByKey_${$}_openAppKeys$`](),_=t[`session_workspaceByKey_${$}_appById_${d}_appKeys$`]();return this.h`<div id='scope_pfgf892'>
        <style>${`
          #scope_pfgf892 {
            & > div {
        ...
        <div class=${{invisible:c!=="open"||f[0]===m}}>
  ...
  />`});u("permissionDialog",function(){let e=P("<permission-dialog>",()=>({isOpen$(){return this.queue$().length>0},close(){let o=this.queue$().length,i=Promise.resolve();for(;o-- >0;)i=i.then(()=>this.resolveCurrent(!1))},queue$:[],getPermissionId(o){return`${o.app.id}:${o.name}:${o.eKind??""}`},isSingularPermission(o){return o.eKind==null||o.eKind===5},addPermissionRequest(o){this.queue$(i=>{let s;return this.isSingularPermission(o)&&(s=i.find(r=>r.id===o.id))?(s.promise.then(o.resolve).catch(o.reject),i):(i.push({id:o.id,app:{id:o.app.id,napp:o.app.napp,alias:o.app.alias,name:o.app.name,icon:{fx:o.app.icon?.fx,url:o.app.icon?.url}},name:o.name,eKind:o.eKind,meta:{...o.meta},promise:o.promise,resolve:o.resolve,reject:o.reject}),i)})},removeCurrent(o){if(this.queue$().length===0)return;let i=o??this.queue$()[0];this.queue$(s=>o?s.filter(r=>r.id!==i.id):s.slice(1))},async resolveCurrent(o,i){if(this.queue$().length===0)return;let s=i??this.queue$()[0];if(o){if(this.isSingularPermission(s)){s.resolve(!0),this.removeCurrent(i);return}await ue(s.app.id,s.name,s.eKind),s.resolve(!0),this.removeCurrent(i)}else s.reject(new Error("Permission denied")),this.removeCurrent(i)},async queryPermission(o){return o.eKind==null||o.app.id&&o.name==="openApp"?!1:de(o.app.id,o.name,o.eKind)},async requestPermission(o){if(await this.queryPermission(o))return!0;let s=Promise.withResolvers();return this.addPermissionRequest({...o,...s,id:this.getPermissionId(o)}),s.promise}})),t=y(()=>({isOpen$:e.isOpen$,close:e.close.bind(e),shouldAlwaysDisplay$:!0,render:R(function(){return this.h`<permission-dialog-stack />`})}));return this.h`<a-modal props=${t} />`});u("permissionDialogStack",function(){let e=x(localStorage),t=P("<permission-dialog>"),o=A("<permission-dialog-stack>",()=>({resolveCurrent:t.resolveCurrent.bind(t),eKindToText:{0:"profiles",1:"short text notes",3:"follow lists",6:"renotes",7:"reactions",16:"renotes",20:"pictures",21:"videos",9734:"zaps",30023:"long text notes"},getEKindToText(i,s){if(s==="readProfile")return"your profile";let r=this.eKindToText[i];return r||(i==null?r="an item":r=`kind ${i} items`),r},nameToText:{readProfile:"read",signEvent:"publish",encrypt:"encrypt",decrypt:"decrypt",openApp:"open"},getNameToText(i){return this.nameToText[i]||i},getPemissionText(i,s,r){let n;if(s===22242)n="tell servers who you are";else if(s===5){let a=r?.params?.[0];if(!a)throw new Error("Missing event parameter for eKind 5 permission");let p=["e","a"],l=a.tags.filter(d=>p.includes(d[0])).length||1;n=`delete ${l} ${l===1?"item":"items"}`}else if(i==="openApp"){let{targetApp:a}=r??{};if(!a)throw new Error("Missing app parameter for openApp permission");let{[`session_appById_${a.id}_name$`]:p}=e,l=a.name||p()||a.alias||a.napp;if(l==null)throw new Error("Missing app name for openApp permission");n=`${this.getNameToText(i)} the ${l} napp`}if(!n){let a=this.getEKindToText(s,i);n=[this.getNameToText(i),a].filter(Boolean).join(" ")}return"Can I "+n+"?"},permissionRequests$(){return t.queue$()}}));return this.h`
    ...
    `}</style>
    <div id='permission-dialog-stack' class=${L.defaultTheme}>
