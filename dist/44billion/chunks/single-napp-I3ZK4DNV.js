import{a as S,c as I,d as A}from"./chunk-6VBLV2W6.js";import{c as k}from"./chunk-4NYNH44B.js";import"./chunk-DF4IVW5S.js";import{h as b,k as w,n as y}from"./chunk-YCNW34TK.js";import{b as g}from"./chunk-KN6GOQRR.js";import{h as u,k as a,o as m,t as i,w as $}from"./chunk-K2UKPH6Q.js";u("singleNapp",function(){let c=g(localStorage),{session_openWorkspaceKeys$:s}=c,o=s()[0];if(!o)throw new Error("User n/a");return I(()=>({isOpen$:!1,open(){this.isOpen$(!0)},close(){this.isOpen$(!1)}})),i("napp",()=>{let r,l=[window.location].map(e=>(e.pathname.replace(/\/\+{1,3}[^/?#]+\/?/,p=>(r=p.replace(/^\/|\/$/g,""),"")).replace(/\/$/,"")+e.search+e.hash).replace(/^([^?#])/,"/$1"))[0],n=k(r),t=y(n);return{wsKey:o,appId:t,initialRoute:l}}),this.h`
    <vault-modal />
